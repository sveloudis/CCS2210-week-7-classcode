...
// ONE LAST THING - WHAT IF THE USER CLICKED ON SUBMIT WITHOUT SELECTING A FILE
...
// DEALING WITH TYPE OF THE FILE
	// Allow certain file formats
	if($imgFileTypeExt != "jpg" && $imgFileTypeExt != "png" && $imgFileTypeExt != "jpeg" && $imgFileTypeExt != "gif" ) {
		echo "Sorry, only JPG, PNG, JPEG, & GIF files are allowed.";
		$uploadOk = 0;
	}
	else
		echo "This is a type of file that is indeed allowed to be uploaded.";


// ******* DEALING WITH TYPE OF THE FILE CORRECTLY
